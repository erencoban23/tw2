...
twitch_miner = TwitchChannelPointsMiner(
    username="erencobaan",
    password="bspwelteren12",           # If no password will be provided, the script will ask interactively
    ...
    logger_settings=LoggerSettings(
        ...
        webhook=Webhook(
            endpoint="https://discord.com/api/webhooks/1347684875498553364/xhB14MTAr3QTxl_OYvzTJhpF7dzwq2Qu_rNLE1X5C88lJxdSXE1tjBWxfJc3mdcFHqPn",                                                                    # Webhook URL
